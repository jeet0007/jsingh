...
const skillCategories = [
  { title: "Languages", skills: ["TypeScript", "JavaScript", "Java"], color: "gray" as const },
  { title: "Front-End", skills: ["React", "Next.js", "Angular", "Redux-Saga"], color: "blue" as const },
  { title: "Back-End", skills: ["Node.js", "Express.js", "Spring Boot", "Socket.IO"], color: "green" as const },
  { title: "Databases", skills: ["PostgreSQL", "MongoDB", "Redis"], color: "purple" as const },
  { title: "DevOps & CI/CD", skills: ["Docker", "Jenkins", "Argo CD", "AWS S3"], color: "orange" as const },
  { title: "Methodologies & Tools", skills: ["Agile", "SDLC", "Unit Testing", "Jira"], color: "indigo" as const }
];
