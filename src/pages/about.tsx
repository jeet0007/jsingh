	...
	return (
		<section className="mb-16">
			...
			<p className="text-gray-700 mb-4">
				...
				platforms, languages, and embedded systems. Experienced with the latest
				cutting edge development tools and procedures. Able to effectively
				self-manage during independent projects, as well as collaborate as part
				of a productive team.
			</p>
			<p className="text-gray-700">
				Great relationship with leadership and clients. As was appointed for
				Technical Account Officer role within the 2nd year at my job.
			</p>
		</section>
	);
};
